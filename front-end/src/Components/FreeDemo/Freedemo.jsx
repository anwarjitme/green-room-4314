    ...
    <Box border="1px solid none" w="100%" h="135vh" bg="#2e475d"  >
        <Flex justifyContent="space-evenly">
            <Box border="1px solid none" w="40%" h="100vh" mt="100px" marginLeft="100px" >
                <Container fontSize="40px" fontWeight="600" color="white"  >
                    <h1>Get a Free Demo of HubSpot's <br></br> CRM Platform</h1>
                </Container>
                ...
                <Container fontSize="30px" fontWeight="700" mt="20px" color="white" mr="10">
                Popular features
                </Container>
